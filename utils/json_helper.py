...
class JSONHelper:
    ...
    def write_actions(self, irs, itns): 
        ...
        self.json_obj["Events"][0]["Event_Coordinator_Config"]["Demographic_Coverage"] = str(irs)
        self.json_obj["Events"][1]["Event_Coordinator_Config"]["Demographic_Coverage"] = str(itns)
